...
(function() {
  var Backbone, CollectionExposerGeneric, CollectionExposerHttpFancy, CollectionExposerHttpRaw, Select, Validator, async, callbackToRes, errDataToRes, helpers, v, _;
  ...
  CollectionExposerHttpRaw = exports.CollectionExposerHttpRaw = Validator.ValidatedModel.extend4000({
    ...
    initialize: function() {
      ...
      app.post(helpers.makePath(path, name, 'remove'), (function(_this) {
      ...
      return app.post(helpers.makePath(path, name, 'find'), (function(_this) {
        return function(req, res) {
          var reslist;
          reslist = [];
