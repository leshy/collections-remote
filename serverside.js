...
(function(){
  var helpers, Backbone, _, async, Validator, v, Select, callbackToRes, errDataToRes, CollectionExposerHttpRaw, CollectionExposerHttpFancy, subscriptionMan, CollectionExposerGeneric;
  ...
  CollectionExposerHttpFancy = exports.CollectionExposerHttpFancy = Validator.ValidatedModel.extend4000({
    ...
    initialize: function(){
      ...
      app.post(helpers.makePath(path, name, 'create'), function(req, res){
        var this$ = this;
        this.applyPermission(this.permissions.create, msg, getRealm(req), function(err, msg){
          if (err) {
